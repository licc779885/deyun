...
Page({
  ...
  gotoConfirm: function (e) {
    ...
    var t = this,
      ...
      s = t.data.dataAll,
      o = [];
    console.log("_order_all", d);
    for (var r in d) {
      var i;
      if ("" == s.address_block && void 0 == s.address_block || s.address && (i = t.data.address_id), !t.data.is_show_dispatch_type_block && void 0 === t.data.address_id) return void wx.showToast({
        title: "请选择收货地址",
        icon: "success",
        duration: 2e3,
        mask: !0
    ...
    k += "&order=" + JSON.stringify(o), console.log(k), a._getNetWork({
      ...
      success: function (a) {
        ...
        var e = a.data,
          t = "../orderPay/orderPay?order_id=" + e.data.orderid;
  ...
  switch2deductcredit2: function (a) {
    var e = this,
      t = parseInt(a.currentTarget.dataset.value),
      d = e.data.realprice_total,
      s = 0;
  ...
  _getData: function (e) {
    ...
    var t = this,
      ...
      s = e.goods_id;
    a._postNetWork({
      url: a.getNetAddresss("order.goods-buy"),
      showToastIn: !1,
      data: {
        cart_ids: e.cart_ids,
        goods_id: e.goods_id,
      ...
      success: function (a) {
        var e = a.data.data;
        console.log("我的订单", a);
        var o = e.is_show_dispatch_type_block,
          r = e.contacts_block,
          i = (e.address_block, !1);
        if (e.address) {
          i = !0;
          t.setData({
            ...
            address_title: e.address_block.title,
  ...
  onShow: function () {
    ...
    wx.getStorage({
      ...
      key: "ORDER_COUPON_SELECT_DATA",
      success: function (e) {
        console.log("ORDER_COUPON_SELECT_DATA", e), a.setData({
          _couponId: e.data
        })
      }
    }), wx.getStorage({
